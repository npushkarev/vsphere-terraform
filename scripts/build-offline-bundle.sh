...
cp "$project_dir/vsphere.py" "$stage/scanner/"
...
cp "$project_dir/.terraform-version" "$stage/scanner/"
...
cp "$project_dir/docs/python-launcher.md" "$stage/scanner/PYTHON-LAUNCHER.md"
cp "$project_dir/docs/state.md" "$stage/scanner/state.md"
